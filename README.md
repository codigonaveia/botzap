<h1>BOT WHATSAPP COM PYTHON</h1>

<p>
 Nesta pequena aplicação crie um bot para enviar mensagem pelo Whatsap.
</p>
<br/>
<p style="color:blue;">:alien:1° Linguagem Python<p/>
<p style="color:blue;">:alien:2° Chrome Drive<p/>
